...
function tidyUpStrings(arrayOfStrings) {
  let arrayOfTidyStrings = [];
  for (let i = 0; i < arrayOfTidyStrings.length; i++) {
    arrayOfTidyStrings.push(arrayOfTidyStrings[i].replaceAll('/','').toLowerCase().trim());
  }
    return arrayOfTidyStrings;
}
